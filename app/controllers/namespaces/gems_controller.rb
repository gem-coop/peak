class Namespaces::GemsController < Public::BaseController
  ...
  rate_limit to: 10, within: 1.minute, by: :push_key_rate_limiting_key, with: -> { head :too_many_requests }, only: :create
  ...
  private
    def push_key_rate_limiting_key
      Digest::SHA256.hexdigest request.authorization.to_s
    end
